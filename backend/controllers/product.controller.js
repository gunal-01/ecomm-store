...
export const createProduct = async (req, res) => {  // this router.post("/products, async (req, res) => sets up the route handler for GET request to /products. The handler function is asynchronous to allow for the use of await inside.
